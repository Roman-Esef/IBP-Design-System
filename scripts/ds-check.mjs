...
/* ============================================================
   ...
   Для страниц НЕ на docs-split (genOD-экраны, старые страницы) шаги 2–3
...
if (isDocsSplit) {
  steps.push(['docs-split check', [DOCS_SPLIT, 'check', pageRel]]);
  steps.push(['docs-split verify', [DOCS_SPLIT, 'verify', pageRel]]);
}
