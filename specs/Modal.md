...
- **Рекомендации** — Модалка — прерывание, а не страница. Вложенность ограничена одним confirm/alert поверх модалки; для многошаговых сценариев — Tab внутри модалки или отдельная страница. Крестик обязателен всегда, даже если внизу уже есть кнопка «Закрыть».
