...
- **Кнопки страниц и стрелки** — Навигация пагинатора собрана из трёх типов элементов: кнопка-номер страницы, кнопка-стрелка (prev/next) и неинтерактивный «…». Раздел описывает их структуру, состояния и поведение — отдельно от композиции строки, чтобы разработчик мог собрать кнопку как самостоятельный примитив.
